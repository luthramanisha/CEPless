...
object Dsl {
 ...
 // def tumblingWindow (instances: Instances): Window = TumblingInstances (instances.i)
  ...
  def overhead: MessageHopsHelper.type = MessageHopsHelper

  case object MessageHopsHelper {
    def === (overhead: Int): MessageHopsHelper2 = MessageHopsHelper2 (Equal, overhead)
    def =!= (overhead: Int): MessageHopsHelper2 = MessageHopsHelper2 (NotEqual, overhead)
    def >   (overhead: Int): MessageHopsHelper2 = MessageHopsHelper2 (Greater, overhead)
    def >=  (overhead: Int): MessageHopsHelper2 = MessageHopsHelper2 (GreaterEqual, overhead)
    def <   (overhead: Int): MessageHopsHelper2 = MessageHopsHelper2 (Smaller, overhead)
    def <=  (overhead: Int): MessageHopsHelper2 = MessageHopsHelper2 (SmallerEqual, overhead)
  }
  ...
  case class MessageHopsHelper2(operator: Operator, load: Int) {
    def otherwise(otherwise: Option[MessageHopsMeasurement]): MessageHopsRequirement =
      MessageHopsRequirement(operator, load, otherwise)
  }
  ...
  abstract class PlacementOverheadMeasurement() extends Measurement {
    def apply(usage: Long): Any
  }
  ...
  case class Query1Helper[A](q: Query1[A]) {
    ...
    def customOperator[B]    (operatorName: String,                                 requirements: Requirement*): Query1[A] =                                                                                  Test          (operatorName, q,            requirements.toSet)
    def benchmark[B]         (                                                      requirements: Requirement*): Query1[A] =                                                                                  Benchmark     (q,                          requirements.toSet)
    def forward[B]         (                                                      requirements: Requirement*): Query1[A] =                                                                                    Forward     (q,                          requirements.toSet)
  }
